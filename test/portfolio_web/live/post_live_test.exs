defmodule PortfolioWeb.PostLiveTest do
  use PortfolioWeb.ConnCase

  import Phoenix.LiveViewTest
  import Portfolio.BlogFixtures

  @create_attrs %{context: "some context", title: "some title", slug: "some slug", published_at: "2024-11-04T20:17:00"}
  @update_attrs %{context: "some updated context", title: "some updated title", slug: "some updated slug", published_at: "2024-11-05T20:17:00"}
