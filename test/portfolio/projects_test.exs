defmodule Portfolio.ProjectsTest do
  ...
  describe "projects" do
    ...
    @invalid_attrs %{description: nil, title: nil, url: nil, tech_stack: nil, featured: nil}
    ...
    test "create_project/1 with valid data creates a project" do
      valid_attrs = %{description: "some description", title: "some title", url: "some url", tech_stack: ["option1", "option2"], featured: true}
